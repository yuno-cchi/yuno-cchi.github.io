...
const CONFIG = {
	...
	// Weather
	weatherKey: '2565af857711ae887a0c4df89dbfe607', // Write here your API Key
	weatherIcons: 'White', // 'Onedark', 'Nord', 'Dark', 'White'
	weatherUnit: 'C', // 'F', 'C'
	language: 'en', // More languages in https://openweathermap.org/current#multi

	trackLocation: false, // If false or an error occurs, the app will use the lat/lon below
	defaultLatitude: '1.348',
	...
	firstlistsContainer: [
		{
			...
			links: [
				{
					name: 'NTULearn',
					link: 'https://ntulearn.ntu.edu.sg/',
				},
				{
					name: 'STARS',
		...
		},
		{
			...
			links: [
				...
				{
					name: 'NTU OneDrive',
					link: 'https://entuedu-my.sharepoint.com/',
				},
				{
					name: 'Calendar',
